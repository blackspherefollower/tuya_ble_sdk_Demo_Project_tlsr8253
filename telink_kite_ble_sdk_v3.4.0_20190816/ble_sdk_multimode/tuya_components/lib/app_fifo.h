...
//typedef struct
//{
//    unsigned char *          p_buf;           /**< Pointer to FIFO buffer memory.                      */
//    unsigned short           buf_size_mask;   /**< Read/write index mask. Also used for size checking. */
//    volatile unsigned int  read_pos;        /**< Next read position in the FIFO buffer.              */
//    volatile unsigned int  write_pos;       /**< Next write position in the FIFO buffer.             */
//} app_fifo_t;
//
